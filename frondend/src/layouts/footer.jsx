...
import ButtonComp from '../components/Button/botton';
                ...
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
                        <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                            <a href="#" class="flex justify-center lg:justify-start">
                                <img src={logo} class="w-56"></img>
                            </a>
                            <p class="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">SOME TEXT</p>
                            <div >
                                <ButtonComp
                                    label="Contact Us"
                                    onClick={handleClick}
                        ...
                        <div class="lg:mx-auto text-left ">
                            <h4 class="text-lg text-gray-900 font-medium mb-7">Help</h4>
                            <ul class="text-sm  transition-all duration-500">
                                <li class="mb-6"><a href="javascript:;" class="text-gray-600 hover:text-gray-900">Contact us</a></li>
                                <li class="mb-6"><a href="javascript:;" class="text-gray-600 hover:text-gray-900">About us</a></li>
                                <li class="mb-6"><a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Returns & Shipping</a></li>
                                <li class="mb-6"><a href="javascript:;" class=" text-gray-600 hover:text-gray-900">FAQs</a></li>
                                <li><a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Careers</a></li>
                            </ul>
                        </div>
                        {/* <!--End Col--> */}
                        <div class="lg:mx-auto text-left ">
                            ...
                            <ul class="text-sm  transition-all duration-500">
                                <li class="mb-6"><a href="javascript:;" class="text-gray-600 hover:text-gray-900">Eye exams</a></li>
                                <li class="mb-6"><a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Styling appointments</a></li>
                                <li class="mb-6"><a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Size guide</a></li>
                                <li><a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Face shape guide</a></li>
                            </ul>
                        </div>
                        {/* <!--End Col--> */}
                        <div class="lg:mx-auto text-left">
                    ...
                    <div class="py-7 border-t border-gray-200">
                        <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                            <span class="text-sm text-gray-500 ">©<a href="#">LensLux</a> 2024, All rights reserved.</span>
                            <div class="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                                <a href="javascript:;" class="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-[#F36527]">

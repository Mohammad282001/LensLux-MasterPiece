...
import TryOnBtn from "../components/some";
...
const ProductDetails = () => {
    ...
    const DiscountLabel = ({ discount_price, discount_percentage }) => {
        if (discount_price || discount_percentage) {
            const discountText = discount_price
                ? `${parseFloat(discount_price).toFixed(2)} JOD OFF`
    ...
    const PriceDisplay = ({ price, discount_price, discount_percentage }) => {
        ...
        const discountedPrice = discount_price
            ...
            : discount_percentage
                ? (originalPrice * (1 - parseFloat(discount_percentage) / 100)).toFixed(2)
                : null;
        ...
        <div className="bg-white min-h-screen">
                            ...
                            <div>
                                ...
                                <div className="flex items-center mb-6 space-x-4">
                                    ...
                                    <motion.button
                                        ...
                                        whileTap={{ scale: 0.95 }}
                                        className={`flex items-center px-6 py-3 text-white text-lg font-medium rounded-lg transition duration-300 ${product.stock_quantity > 0
                                ...
                                <p
                                    className={`text-lg font-semibold mb-4 ${product.stock_quantity > 0
                                        ? "text-green-600"
                                        : "text-red-500"
                                        }`}
                                >
                            ...
                            <div className="flex space-x-4 mt-4">
                                {images.map((img, index) => (
                                    <motion.button
                                        ...
                                        whileHover={{ scale: 1.05 }}
                                        whileTap={{ scale: 0.95 }}
                                        className={`w-20 h-20 border-2 rounded-lg ${currentImage === index
                                            ? "border-black"
                                            : "border-transparent"
                                            }`}
                                    >
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="mt-12 space-y-6">
                    ...
                    <div className="">
                        <h3 className="text-lg font-semibold mb-4 mt-20">Compare with Similar Products</h3>
                    ...
                    <div className="">
                        <h3 className="text-2xl font-semibold mb-6 mt-20">Customer Reviews</h3>
                    ...
                    <div className=" flex flex-col ">
                        <h3 className="text-2xl font-semibold mb-6 mt-20">Frequently Asked Questions</h3>
